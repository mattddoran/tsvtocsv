...
class Q2(Question):
    ...
    # opens the file generated by the query and then converts the data into a lists: director experience x and rank y
    def process(self):
        # basically make a dictionary where lists of year and rating are stored for coresponding directors
        ...
        for director in directorShows.keys():
            ...
            for info in directorShows[director]:
                ...
                x.append(count) #rank based on number of shows iterated through
                y.append(float(info[1])) #rating of the show
                count += 1
        return x, y

    # creates a scatter plot of all director experience x and rank y
    def visualize(self):
        x, y = self.process()
